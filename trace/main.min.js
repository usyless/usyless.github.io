...
r()});q(a,{buttons:"Exit",o:["themePopup"],v:d=>{d.classList.remove("blur");const {bottom:f,right:h}=Va.getBoundingClientRect();d.firstElementChild.style.setProperty("--yOffset",`${window.innerHeight-f}px`);d.firstElementChild.style.setProperty("--xOffset",`${window.innerWidth-h}px`)}})});
